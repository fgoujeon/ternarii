...
using vertical_dynamite_tile                = libcommon::data_types::vertical_dynamite_tile;
using vertical_dynamite_tile_explosion      = libcommon::data_types::vertical_dynamite_tile_explosion;
using vertical_dynamite_tile_explosion_list = libcommon::data_types::vertical_dynamite_tile_explosion_list;
