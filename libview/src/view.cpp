...
void view::make_vertical_bomb_tiles_explode(const data_types::vertical_bomb_tile_explosion_list& explosions)
{
    pimpl_->tile_grid_.make_vertical_bomb_tiles_explode(explosions);
}
