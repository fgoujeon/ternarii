...
#ifndef LIBVIEW_2P_DATA_TYPES_HPP
#define LIBVIEW_2P_DATA_TYPES_HPP
...
namespace libview_2p { namespace data_types
{
...
using tile_pool = std::array<std::array<item, 2>, 6>;
...
}} //namespace libview_2p::data_types
